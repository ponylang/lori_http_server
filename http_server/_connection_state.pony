trait ref _ConnectionState
  ...
  Dispatches lori events to the appropriate protocol methods based on
  ...
  fun ref on_received(proto: HTTPServer ref, data: Array[U8] iso)
    """Handle incoming data from the TCP connection."""

  fun ref on_closed(proto: HTTPServer ref)
    """Handle connection close notification."""

  fun ref on_throttled(proto: HTTPServer ref)
    """Handle backpressure applied notification."""

  fun ref on_unthrottled(proto: HTTPServer ref)
...
class ref _Active is _ConnectionState
  ...
  fun ref on_received(proto: HTTPServer ref, data: Array[U8] iso) =>
    proto._feed_parser(consume data)

  fun ref on_closed(proto: HTTPServer ref) =>
    proto._handle_closed()

  fun ref on_throttled(proto: HTTPServer ref) =>
    proto._handle_throttled()

  fun ref on_unthrottled(proto: HTTPServer ref) =>
    proto._handle_unthrottled()
